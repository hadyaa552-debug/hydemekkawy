    ...
    <section id="location" className="py-20 lg:py-32 bg-muted/30">
      <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">في قلب التجمع السادس</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            موقع استراتيجي يوفر سهولة الوصول لجميع الخدمات الحيوية والترفيهية والتعليمية والتجارية في القاهرة الجديدة.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-[4/3] overflow-hidden shadow-2xl">
            <Image src="/images/high3-2.webp" alt="موقع Hyde Park Central" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
          </div>
        </div>
      </div>
    </section>
